...
Identity and the contact data of the Supplier of products and/or services (also referred to in this Privacy Policy the “Supplier of products and/or services” or the”Controller”`}</p>
        <h2>H.Q. MANCHESTER LTD </h2>
        <ul className='italic w-full text-[12px]'>

          <li key={"itemIndex"}><p >Address: 317 Wilmslow Road, <br></br>  Manchester<br></br> M14 6NW,<br></br> United Kingdom</p></li>
          <li>Public phone: +44 161 425 5080</li>
          <li>Website: www.hq-manchester.co.uk</li>
          <li>Company registration number: 14586850</li>
        </ul>

        <div className=" leading-relaxed ">
        <p>
          1.1. Contact data of the data protection officer (“DPO”) may be found on the websitewww.hq-manchester.co.uk, as long as it was (necessary to be) appointed such data protection officer.
          <br /> <br />
        ...
        <p>
          <br />
          4. Recipients or the category of recipients of the personal data <br />
          ...
          <br /><br />
          5. Transfers of personal data to third countries or an international organization </p>
        <p> 5.1. An eventual transfer or a set of transfers of personal data to a third country or an international organisation shall take place only on one of the following conditions:
          <br />
        ...
        <p> 
        <br />7. Obligation to provide the personal data and of the possible consequences of failure to provide such data
          <br />
        ...
        <p> <br />8. Right of access by the data subject
          <br />
        ...
        <p> <br />9. Right to rectification
          <br />
          The data subject has the right to obtain from the Controller without undue delay, the rectification of inaccurate personal data concerning him or her. Taking into account the purposes of the processing, the data subject has the right to have incomplete personal data completed, including by means of providing a supplementary statement.

        </p>
        <p> <br />10. Right to erasure (‘right to be forgotten’)
          <br />
        ...
        <p> <br />11. Right to restriction of processing
          <br />
        ...
        <p> <br />15. Automated individual decision-making, including profiling
          <br />
        ...
        <p> <br />21. Withdrawal of the consent
          ...
          <br />
          24.3. Any requests and/or demands sent by you towards the Controller for exercising any of your rights may be made in writing, by registered letter that will be sent to the headquarter of the Controller and/or online via the contact for or contact email of the Controller as found on the website www.hq-manchester.co.uk or at the email of the DPO, if such DPO exists, and/or by any other ways of communications mentioned in the legal regulations in force.
          <br />
