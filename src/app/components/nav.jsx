    ...
    <div className=''>
      ...
      {navbar && <div id='menu' className=' absolute top-[72px]  rounded-md bg-black  w-screen shadow-sm flex max-w-[660px] h-[460px] flex-col items-start z-20'>
        ...
        <div className='p-4 mt-4  flex flex-col gap-3 font-bold justify-center '>
          ...
          <Link onClick={handleNav} className=''  href={"https://www.facebook.com/hqmanchester"}target="_blank" ><FaFacebook /></Link><Link onClick={handleNav}  href={"https://www.instagram.com/hqmanchester/"} target="_blank"><FaInstagram /></Link>
